  ...
  return (
    <>
      ...
      <div className="about-us-info">
        <p>
          Queen's People Watching Club is a non-profit organization that watches
          targetted individuals for meticulous reasons that are confidential to
          only the watcher themselves.
        </p>
        <br />
        <p>
          ...
          world, through the lives of other fellow human beings that are minding
          their own business.
        </p>
        <a href="/">
